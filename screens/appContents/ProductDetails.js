...
const ProductDetails = ({ navigation, route }) => {
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={{ marginHorizontal: 15, marginTop: 8, flexDirection: 'row', display: 'flex', justifyContent: 'space-between', height: '8%' }}>
            ...
            <View style={{ marginHorizontal: 15, flexDirection: 'row', display: 'flex', justifyContent: 'space-between', }}>
